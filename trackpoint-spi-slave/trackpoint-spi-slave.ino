...
// 25 Hz MOT (40ms period) — align with BLE connection interval.
...
//   A→B: Fast right     (+8,  0) ×  25 steps  200 px/s
//   B→C: Slow down      ( 0, +4) ×  50 steps  100 px/s
//   C→D: Extrafast left (-16, 0) ×  13 steps  400 px/s (~208px)
//   D→A: Normal up      ( 0, -8) ×  25 steps  200 px/s
...
static const int8_t rect_data[4][3] PROGMEM = {
    {  8,  0, 25  },   // A→B: Fast right     (+8,  0) ×  25  200 px/s
    {  0,  4, 50  },   // B→C: Slow down      ( 0, +4) ×  50  100 px/s
    { -16, 0, 13  },   // C→D: Extrafast left (-16, 0) ×  13  400 px/s
    {  0, -8, 25  },   // D→A: Normal up      ( 0, -8) ×  25  200 px/s
};
...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println("--- PMW3610 emulator Exp16b ---");
    Serial.println("Synthetic rectangle over BLE (25 Hz)");
}
